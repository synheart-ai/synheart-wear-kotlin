 ...
 */
enum class RamenConnectionState {
    CONNECTING,
    CONNECTED,
    DISCONNECTED,
    RECONNECTING
...
class RamenClient(
    ...
    private val _errors = MutableSharedFlow<Error>(extraBufferCapacity = 16)
    ...
    fun connect() {
        ...
        val authedStub = io.grpc.stub.MetadataUtils.attachHeaders(stub, metadata)
    ...
    private fun onServerError(err: ramen.v1.Ramen.Error) {
